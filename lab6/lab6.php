...
// The way to do this without the ifs would be to map the operation names to their respective class names
// then use a loop to go through the map and check which operation was requested and instantiate the corresponding class dynamically.
